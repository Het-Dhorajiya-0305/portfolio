                ...
                >
                    <div className="space-y-6 text-justify max-lg:felx-1">
                        ...
                        <div className="flex sm:flex-row gap-4 pt-4 justify-center">
                            ...
                            <a href="#contact" className='px-6 py-2 rounded-full border border-primary text-primary hover:bg-primary/10 transition-colors duration-300 w-max'>Download CV</a>
                        </div>
                    </div>
