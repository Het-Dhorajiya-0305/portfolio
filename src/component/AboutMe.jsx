    ...
    return (
        <div id='about' className='py-24 px-4 relative'>
            <div className="container mx-auto max-w-5xl">
                <h2 className='text-3xl md:texl-4xl font-bold mb-12 text-center'>
                ...
                >
                    <div className="space-y-6 text-start">
                        <h3 className='text-2xl font-semibold'> Hello! I'm Het Dhorajiya </h3>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <div className="p-6 relative">
                            <img src={heroImage} alt="" className='rounded-full animate-float' />
                        </div>
